    ...
    return (
        <div className='space-y-10'>
            <section className='text-center space-y-6'>
                <h4 className='italic text-xl font-medium text-gray-500'>Our Team Members</h4>
                <h1 className='text-5xl font-bold font-[inter]'>Meet Our Expert <hr />
            ...
            <section className='sm:px-32'>
                ...
                >
                    <SwiperSlide className='min-h-[40vh]'>
                        <div class="items-center bg-gray-50 rounded-lg shadow-lg shadow-purple-500 sm:flex dark:bg-gray-800 dark:border-gray-700 ">
                            <a href="#">
                            ...
                            <div class="p-5">
                                ...
                                <span class="text-gray-500 dark:text-gray-400">Eurology</span>
                    ...
                    <SwiperSlide className='min-h-[40vh]'>
                        <div class="items-center bg-gray-50 rounded-lg shadow-lg shadow-purple-500  sm:flex dark:bg-gray-800 dark:border-gray-700">
                            <a href="#">
                                <img class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/jese-leos.png" alt="Bonnie Avatar"/>
                            </a>
                            <div class="p-5">
                                <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                    <a href="#">Bonnie Green</a>
                                </h3>
                                <span class="text-gray-500 dark:text-gray-400">Neprology</span>
                                <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Bonnie drives the technical strategy of the flowbite platform and brand.</p>
                                <ul class="flex space-x-4 sm:mt-0">
                                    <li>
                                        <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                    ...
                    <SwiperSlide className='min-h-[40vh]'>
                        <div class="items-center bg-gray-50 rounded-lg shadow-lg shadow-purple-500 sm:flex dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div class="p-5">
                                ...
                                <span class="text-gray-500 dark:text-gray-400">Cardiology</span>
                                <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Bonnie drives the technical strategy of the flowbite platform and brand.</p>
                                <ul class="flex space-x-4 sm:mt-0">
                                    <li>
                                        <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
